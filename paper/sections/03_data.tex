...
However, this did not improve the results.\todo[inline]{könnte es sein, dass wir das gemacht haben, als das Stacking noch kaputt war?}
...
\todo[inline]{Who has the table values?}
\begin{table}[H]
\centering
...
Secondly, the random cropping in Caffe is at least as effective \todo[inline]{effective ist hier ungenau (bedeutung), ausserdem hilft das feste cropping mit der Varianz der Bilder, da caffe oft in der mitte cropped} as manually cropping and can save us some work.
...
From every videos' frame pool we selected these 16 frames by omitting the first and last five frames\todo[inline]{Ich glaube, das machen wir nicht mehr}, and the equally distributing the selected frames among the remaining frames.
