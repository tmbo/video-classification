...
We worked on the first split, i.e. trainlist01.txt and testlist01.txt\footnote{\url{http://crcv.ucf.edu/data/UCF101/UCF101TrainTestSplits-RecognitionTask.zip}}. % the first thirds were used for training, and the last one was used for testing.
...
This is why we decided to use a fixed frame rate of \todo{Frame rate} frames per second.
