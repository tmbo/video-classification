...
\begin{figure}[!htb]
	...
	\caption{The results of our neural network: On the top the video with the overall classification summary given by the top five label probabilities is given. In the middle the per frame prediction of the \emph{spatial} neural network and on the bottom the per frame prediction of the \emph{flow} neural network is shown.}
	\label{fig:web_app}
\end{figure}
